...
```
__For Mountain Lion users ONLY:__ There's a few extra steps [Part 1 (*note after launchctl use part 2)](https://coderwall.com/p/1mni7w) & [Part 2](http://nextmarvel.net/blog/2011/09/brew-install-postgresql-on-os-x-lion/).
